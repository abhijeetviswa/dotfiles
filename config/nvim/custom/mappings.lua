...
M.general = {
  n = {
    ...
    ["<leader>ff"] = { ":Telescope find_files find_command=rg,--ignore,--hidden,--files<CR>" },
    ["<C-p>"] = { "<leader>ff", "Fuzzy Finder", opts = { remap = true } },
    ...
    -- Buffer helpers
    ["<leader>bd"] = { ":%bd<CR>", "Close all buffers", opts = { remap = true } },
    ["<leader>bdo"] = { ":%bd|e#|bd#<CR>", "Close all buffers but current open", opts = { remap = true } },
  },
  v = {
    -- Clipboard actions
    ["<leader>y"] = { '"*y', "Copy to clipboard", opts = { remap = true } },
